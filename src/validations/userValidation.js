...
const { EMAIL_RULE, EMAIL_RULE_MESSAGE, PASSWORD_RULE, PASSWORD_RULE_MESSAGE } = require('~/utils/validators.js')
...
const update = async (req, res, next) => {
  ...
  try {
    // Lưu ý đối với trường hợp update, cho phép Unknown để không cần lấy một số field lên
...
module.exports = {createNew, verifyAccount, login, update}
