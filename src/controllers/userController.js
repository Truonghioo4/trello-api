...
const login = async (req, res, next) =>{
  try {
     ...
     * Đối với maxAge – thời gian sống của Cookie thì chúng ta sẽ để tối đa 14 ngày, tùy dự án. Lưu ý
...
const logout = async (req, res, next) =>{
  try {
    // Xóa cookie - đơn giản là làm ngược lại với việc gán cookie ở hàm login
...
module.exports = { createNew, verifyAccount, login, logout, refreshToken, update }